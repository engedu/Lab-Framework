...
namespace LabFramework01
{
    public class CommunicationManager
    {
        ...
        /// value
        /// </summary>
        public Display DSOWindow
        {
            get { return _DSODisplay; }
            set { _DSODisplay = value; }
        }
            ...
            _displayWindow.Invoke(new EventHandler(delegate
        {
            ...
            //if (_DSODisplay != null)
            //{
            //    _DSODisplay.Invoke(new EventHandler(delegate
            //  {
            //      _DSODisplay.AppendText(msg);
            //  }));
            //    _DSODisplay.Invoke(new EventHandler(delegate
            //    {
            //        _DSODisplay.ShowMsg();
        ...
        public StringBuilder commString = new StringBuilder();
        void comPort_DataReceived(object sender, SerialDataReceivedEventArgs e)
        {
            ...
            switch (CurrentTransmissionType)
            {
                ...
                case TransmissionType.Text:
                    ...
                    commString.Append(msg);

                    //display the data to the user
//                    if (msg.Length > 0)
//                    {
                      //  DisplayData(MessageType.Incoming, msg + "\n");
                        //dsoData.Add(new DSOData(msg));
                        // Console.WriteLine(msg);
                        //string[] values = msg.Split(new char[] { '[', ']', ':' });
                        //if (values.Length == 4)
                        //{
                        //    int loc = Convert.ToInt32(values[1]);
                        //    dsoData[loc]._CH1 =  Convert.ToInt32(values[2]);
                        //    Console.WriteLine(loc +" " + dsoData[loc]._CH1);
                        //}
